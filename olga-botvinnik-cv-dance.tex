...
% \cvline{}{Studying the ``dark matter'' of genomes since 2017. PhD in single-cell RNA-sequencing. ``Grand unified theory of cells,'' hashing, sequencing weird creatures, STEM outreach. MIT, Broad Institute, UCSC, UCSD. Open science/data/source.}

\cvline{}{PhD in Bioinformatics seeking to spread positive energy through a love of dance.}


\section{Dance Experience}
\cventry{2018--Present}{Trainee}{SimmaWear Pro Dance Training Program}{San Francisco Bay Area, CA}{}{Trained in NFL/NBA professional dance styles with emphasis on hip hop and jazz funk.}

\cventry{2018--2019}{Member}{Boar Hunters Crew}{San Francisco, CA}{}{Member of breakdancing crew. Competed in Cypher Cup and Love MoZaic battles. }
...
% \cventry{2017}{Dance Training}{Culture Shock and Milenium Dance Studios}{San Diego, CA and Los Angeles, CA}{}{Trained in hip hop, jazz, jazz funk, krump, and heels.}
...
\cventry{2007--2011}{Dancer}{MIT DanceTroupe}{Cambridge, MA}{}{Danced in hip hop, contemporary, African, and jazz styles at end-of-semeter performances.}
...
\item Contributed Python and some Rust code to ``sourmash'' software (\href{https://github.com/dib-lab/sourmash}{github.com/dib-lab/sourmash})
\item Developed ``orpheum'' (\href{https://github.com/czbiohub/orpheum}{github.com/czbiohub/orpheum}) tool to extract likely protein-coding reading frames from RNA-seq data
