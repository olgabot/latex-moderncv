...
\cventry{2017--Present}{Chan Zuckerberg Biohub}{Data Sciences}{San Francisco, CA}{Bioinformatics Scientist}{
Investigated biological datasets via machine learning algorithms using a hodgepodge of tools such as Git/GitHub, Python (\texttt{scikit-learn, pandas, jupyter notebook} and friends), AWS, Docker, workflow management languages (Nextflow \href{https://github.com/nextflow-io/nextflow/}{github.com/nextflow-io/nextflow/}), mentored junior scientists and bioinformaticians as part of a fast-paced, diverse, and integrated team.\\\\
Projects:
\begin{itemize}
...
\item Collaborated with a multidisciplinary team in creating the first single-cell atlas of a nonhuman primate
...
\item Led cross-species analyses projects to study ``dark matter'' of transcriptomes using subsampled $k$-mers from translated RNA-seq reads in a reduced amino acid alphabet, to find putative homologous genes across millions of years of evolution
