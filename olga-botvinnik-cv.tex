...
\cvline{}{Genomics expert applying computation to biology. PhD in single-cell RNA-sequencing. ``Grand unifed theory of cells,'' hashing, sequencing weird creatures, STEM outreach. MIT, Broad Institute, UCSC, UCSD. Open science/data/source.}
...
\item Developed \emph{``Grand unified theory of cells''} project to convert cell types between species by hashing (the same concept used in blockchain) of protein k-mers (\href{https://github.com/czbiohub/kmer-hashing}{github.com/czbiohub/kmer-hashing})
\item Investigated \emph{Ixodes scapularis} (deer tick) genome assembly and annotation, in collaboration with \href{http://www.choulab.com/}{Chou Lab at UCSF} (\href{https://github.com/czbiohub/tick-genome}{github.com/czbiohub/tick-genome})
