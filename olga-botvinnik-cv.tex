...
\item Developed \emph{``Grand unified theory of cells''} project to automatically annotate convert cell types across species by hashing of protein k-mers (\href{https://github.com/czbiohub/kmer-hashing}{github.com/czbiohub/kmer-hashing})
