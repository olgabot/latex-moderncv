...
%% Copyright 2016-2024 Olga Botvinnik (olga.botvinnik@gmail.com).
%
...
\cventry{Sep 2024 -- Present}{Seanome}{}{San Francisco, CA}{Founder}{
We build open genomics tools to unlock breakthroughs in ocean diversity.    
}

\cventry{Jan 2022 -- Sep 2024}{Bridge Bio Pharma}{Computational Genomics}{San Francisco, CA}{Senior Computational Biologist}{
...
\cventry{2017--2021}{Chan Zuckerberg Biohub}{Data Sciences Platform}{San Francisco, CA}{Bioinformatics Scientist II}{
    \begin{itemize}
    \item Contributed to \href{https://github.com/czbiohub/tabula-muris}{\emph{Tabula Muris}}, \href{https://tabula-muris-senis.ds.czbiohub.org/}{\emph{Tabula Muris Senis}}, 
        \href{https://tabula-sapiens.sf.czbiohub.org/}{\emph{Tabula Sapiens}}, and \href{http://tabula-microcebus.ds.czbiohub.org/}{\emph{Tabula Microcebus}} 
        single-cell atlases.
    \item Contributed Python and Rust code to ``sourmash'' software for genomic and metagenomic $k$-mer analyses 
        (\href{https://github.com/dib-lab/sourmash}{github.com/dib-lab/sourmash})
    \item Led cross-species analyses projects to study ``dark matter'' of transcriptomes using subsampled $k$-mers from translated RNA-seq reads 
        in a reduced amino acid alphabet, to find putative homologous genes across millions of years of evolution 
            (\href{https://czbiohub.github.io/de-novo-orthology-paper/}{open draft manuscript})
    \item Pioneered weekly weekly internal ``Cupcakes \& Coding'' sessions, alternating between facilitating tutorials taught by junior programmers 
        to share coding knowledge, and pair programming sessions (\href{https://github.com/czbiohub/cupcakes}{github.com/czbiohub/cupcakes}) 
    \item Created \href{https://twitch.tv/bioinformaticsbeyonce}{``BioinformaticsBeyonce''} Twitch channel showcasing open source bioinformatics tools and research 
    \end{itemize}
% Projects:
% \begin{itemize}
...
\section{Education}
\cventry{2017}{Ph.D., Bioinformatics and Systems Biology}{University of California, San Diego}{La Jolla, CA}{}{\href{https://github.com/olgabot/dissertation}{Dissertation}: Computational analysis of single-cell alternative splicing} % arguments 3 to 6 can be left empty
