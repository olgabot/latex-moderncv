...
\cventry{2017--Present}{Chan Zuckerberg Biohub}{Data Sciences}{San Francisco, CA}{Bioinformatics Scientist}{Analyzed large single-cell transcriptome of mouse organs in collaboration with 50+ domain experts to create \emph{Tabula Muris} resource dataset (\url{https://github.com/czbiohub/tabula-muris}), paper accepted in \emph{Nature}. Applied probabilistic machine learning algorithms to biological sequence data, taught weekly ``Cupcakes and Coding'' bioinformatics programming sessions to diverse audiences, as part of a fast-paced, diverse, and integrated team}
